...
DOC_TYPE_MAP = {
    ...
    "Mobile Recharge History": "mobile_recharge",
...
async def create_submission(
    ...
    # Eagerly load documents (empty list for new submission)
...
async def upload_document(
    ...
    # Map doc type
    db_doc_type = DOC_TYPE_MAP.get(doc_type, "utility_bill")
...
async def get_dashboard(
    ...
    pct = 20  # base for having account
